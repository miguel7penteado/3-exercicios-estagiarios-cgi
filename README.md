...
**CGI (Common Gateway Interface)** é o canal usado para permitir a ligação entre o **servidor WWW** e outros **programas executados no sistema operacional do servidor** .   
